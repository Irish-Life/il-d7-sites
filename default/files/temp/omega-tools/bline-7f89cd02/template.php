 ...
 */
  function bline_alpha_process_region(&$vars) {
  ...
  if (in_array($vars['elements']['#region'], array('content', 'menu', 'branding'))) {
    ...
    switch ($vars['elements']['#region']) {
      ...
      case 'branding':
        ...
        $vars['linked_site_name'] = l($vars['site_name'], 'bline', array('attributes' => array('title' => t('Home')), 'html' => TRUE));
        ...
        $vars['linked_logo_img'] = $vars['logo'] ? l($vars['logo_img'], 'bline', array('attributes' => array('rel' => 'home', 'title' => check_plain($vars['site_name'])), 'html' => TRUE)) : '';
        break;
    }
  }
}