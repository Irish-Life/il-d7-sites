...
$databases = array (
  ...
  array (
    'default' =>
    array (
      'database' => 'retail-websites-qaprod',
      'username' => 'retail_user@az-ag-prd-msq-win-dru-001',
      'password' => 'Hufs9228z!@a',
      'host' => 'az-ag-prd-msq-win-dru-001.mysql.database.azure.com',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
    ),
 ...
 *
 */
$drupal_hash_salt = '7eDIgU3zzjm5F0f8B3PmHuatDAS_7pRrllM50lfPfao';
 ...
 * for you.
 */
$base_url = 'https://www.irishlife.ie';  // NO trailing slash!
...
/**
 * Increase the php memory limit to 256M. This setting could also be included
 * in a PHP.INI file
 */
 ...
 */
#$conf['reverse_proxy_addresses'] = array('192.168.1.120','192.168.1.121');
...
$conf['x_frame_options'] = 'allow-from https://www.permanenttsb.ie/';
