...
Drupal.viewsSlideshowPager.nextSlide=function(options){try{if(typeof Drupal.settings.viewsSlideshowPager[options.slideshowID].top.type!="undefined"&&typeof Drupal[Drupal.settings.viewsSlideshowPager[options.slideshowID].top.type].nextSlide=="function")Drupal[Drupal.settings.viewsSlideshowPager[options.slideshowID].top.type].nextSlide(options)}catch(err){}try{if(typeof Drupal.settings.viewsSlideshowPager[options.slideshowID].bottom.type!="undefined"&&typeof Drupal[Drupal.settings.viewsSlideshowPager[options.slideshowID].bottom.type].nextSlide==
"function")Drupal[Drupal.settings.viewsSlideshowPager[options.slideshowID].bottom.type].nextSlide(options)}catch(err){}};Drupal.behaviors.viewsSlideshowPagerFields={attach:function(context){$(".views_slideshow_pager_field:not(.views-slideshow-pager-field-processed)",context).addClass("views-slideshow-pager-field-processed").each(function(){var pagerInfo=$(this).attr("id").split("_");var location=pagerInfo[2];pagerInfo.splice(0,3);var uniqueID=pagerInfo.join("_");if(Drupal.settings.viewsSlideshowPagerFields[uniqueID][location].activatePauseOnHover)$(this).children().each(function(index,
pagerItem){var mouseIn=function(){Drupal.viewsSlideshow.action({"action":"goToSlide","slideshowID":uniqueID,"slideNum":index});Drupal.viewsSlideshow.action({"action":"pause","slideshowID":uniqueID})};var mouseOut=function(){Drupal.viewsSlideshow.action({"action":"play","slideshowID":uniqueID})};if(jQuery.fn.hoverIntent)$(pagerItem).hoverIntent(mouseIn,mouseOut);else $(pagerItem).hover(mouseIn,mouseOut)});else $(this).children().each(function(index,pagerItem){$(pagerItem).click(function(){Drupal.viewsSlideshow.action({"action":"goToSlide",
"slideshowID":uniqueID,"slideNum":index})})})})}};Drupal.viewsSlideshowPagerFields=Drupal.viewsSlideshowPagerFields||{};Drupal.viewsSlideshowPagerFields.transitionBegin=function(options){for(pagerLocation in Drupal.settings.viewsSlideshowPager[options.slideshowID]){$('[id^="views_slideshow_pager_field_item_'+pagerLocation+"_"+options.slideshowID+'"]').removeClass("active");$("#views_slideshow_pager_field_item_"+pagerLocation+"_"+options.slideshowID+"_"+options.slideNum).addClass("active")}};Drupal.viewsSlideshowPagerFields.goToSlide=
function(options){for(pagerLocation in Drupal.settings.viewsSlideshowPager[options.slideshowID]){$('[id^="views_slideshow_pager_field_item_'+pagerLocation+"_"+options.slideshowID+'"]').removeClass("active");$("#views_slideshow_pager_field_item_"+pagerLocation+"_"+options.slideshowID+"_"+options.slideNum).addClass("active")}};Drupal.viewsSlideshowPagerFields.previousSlide=function(options){for(pagerLocation in Drupal.settings.viewsSlideshowPager[options.slideshowID]){var pagerNum=$('[id^="views_slideshow_pager_field_item_'+
pagerLocation+"_"+options.slideshowID+'"].active').attr("id").replace("views_slideshow_pager_field_item_"+pagerLocation+"_"+options.slideshowID+"_","");if(pagerNum==0)pagerNum=$('[id^="views_slideshow_pager_field_item_'+pagerLocation+"_"+options.slideshowID+'"]').length()-1;else pagerNum--;$('[id^="views_slideshow_pager_field_item_'+pagerLocation+"_"+options.slideshowID+'"]').removeClass("active");$("#views_slideshow_pager_field_item_"+pagerLocation+"_"+options.slideshowID+"_"+pagerNum).addClass("active")}};
Drupal.viewsSlideshowPagerFields.nextSlide=function(options){for(pagerLocation in Drupal.settings.viewsSlideshowPager[options.slideshowID]){var pagerNum=$('[id^="views_slideshow_pager_field_item_'+pagerLocation+"_"+options.slideshowID+'"].active').attr("id").replace("views_slideshow_pager_field_item_"+pagerLocation+"_"+options.slideshowID+"_","");var totalPagers=$('[id^="views_slideshow_pager_field_item_'+pagerLocation+"_"+options.slideshowID+'"]').length();pagerNum++;if(pagerNum==totalPagers)pagerNum=
0;$('[id^="views_slideshow_pager_field_item_'+pagerLocation+"_"+options.slideshowID+'"]').removeClass("active");$("#views_slideshow_pager_field_item_"+pagerLocation+"_"+options.slideshowID+"_"+slideNum).addClass("active")}};Drupal.viewsSlideshowSlideCounter=Drupal.viewsSlideshowSlideCounter||{};Drupal.viewsSlideshowSlideCounter.transitionBegin=function(options){$("#views_slideshow_slide_counter_"+options.slideshowID+" .num").text(options.slideNum+1)};Drupal.viewsSlideshow.action=function(options){var status=
{"value":true,"text":""};if(typeof options.action=="undefined"||options.action==""){status.value=false;status.text=Drupal.t("There was no action specified.");return error}if(options.action=="pause"){Drupal.settings.viewsSlideshow[options.slideshowID].paused=1;if(options.force)Drupal.settings.viewsSlideshow[options.slideshowID].pausedForce=1}else if(options.action=="play")if(!Drupal.settings.viewsSlideshow[options.slideshowID].pausedForce||options.force){Drupal.settings.viewsSlideshow[options.slideshowID].paused=
0;Drupal.settings.viewsSlideshow[options.slideshowID].pausedForce=0}else{status.value=false;status.text+=" "+Drupal.t("This slideshow is forced paused.");return status}switch(options.action){case "goToSlide":case "transitionBegin":case "transitionEnd":if(typeof options.slideNum=="undefined"||typeof options.slideNum!=="number"||parseInt(options.slideNum)!=options.slideNum-0){status.value=false;status.text=Drupal.t("An invalid integer was specified for slideNum.")}case "pause":case "play":case "nextSlide":case "previousSlide":var methods=
Drupal.settings.viewsSlideshow[options.slideshowID]["methods"];var excludeMethodsObj={};if(typeof options.excludeMethods!=="undefined")for(var i=0;i<excludeMethods.length;i++)excludeMethodsObj[excludeMethods[i]]="";for(i=0;i<methods[options.action].length;i++)if(Drupal[methods[options.action][i]]!=undefined&&typeof Drupal[methods[options.action][i]][options.action]=="function"&&!(methods[options.action][i]in excludeMethodsObj))Drupal[methods[options.action][i]][options.action](options);break;default:status.value=
false;status.text=Drupal.t('An invalid action "!action" was specified.',{"!action":options.action})}return status}})(jQuery);