...
myILFS._setCallback = function(callback){
    myILFS.callback = callback;
...
if (myILFS.user == "ILFS" )
	...
	stylesheet.href = 'https://www.irishlife.ie/sites/retail/files/3rd-party-apps/ilfsWidget.css?031213';
	...
	html.sliderBox = '<div class="ilfsFormColumn"><div class="row smallRow"><div class="eightcol ilfsDetailsPanel"><fieldset><div class="ilfsSliderTextPanel" style="display:none;"></div><div id="ilfsQuoteSlider"></div></fieldset></div><div class="fourcol ilfsDetailsPanel last sliderResultBlock ' + (ILFSProductTerm ? '' : 'termFalse') + '">&euro;<span id="quoteResult" >100,000</span>' + (ILFSProductTerm ? html.termHolder : '' ) + '</div></div><div class="clearer"></div></div>';
	html.detailsHeader = '<h2 class="ilfsTitle pushDown">Personal Details</h2>';
	html.dobA = '<div class="ilfsDOB" ><select id="ilfsUserA-dob-day" class="ilfsDOBday" ga-change ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="dob-1-day dropdown clicked"></select><select id="ilfsUserA-dob-month" class="ilfsDOBmonth" ga-change ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="dob-1-month dropdown clicked"></select><select id="ilfsUserA-dob-year" class="ilfsDOByear" ga-change ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="dob-1-year dropdown clicked"></select></div>';	
	html.dobB = '<div class="ilfsDOB"><select id="ilfsUserB-dob-day" class="ilfsDOBday" ga-change ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="dob-2-day"></select><select id="ilfsUserB-dob-month" class="ilfsDOBmonth" ga-change ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="dob-2-month dropdown clicked"></select><select id="ilfsUserB-dob-year" class="ilfsDOByear" ga-change ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="dob-2-year get instant clicked"></select></div>';
	...
	// the second screen
	html.detailsNext2 = '<h2 class="ilfsTitle">Your Quote</h2><div class="ilfsFormColumn"><table><thead><th>'+ILFSProductScreenTitle+' Quote</th></thead><tbody><tr><td class="content"><span class="ilfsQuoteResult">&euro;15.00</span> / month<br><span class="tableBreakdownInfo"><a class="quoteBreakdownButton" href="javascript:void(0);"  ga-click ga-category="ilfs-life-quote" ga-action="Page 2" ga-label="Show/Hide Breakdown Button Clicked"><span style="DISPLAY: inline" class="showQuoteBreakdown">Show Breakdown</span><span style="DISPLAY: none" class="hideQuoteBreakdown">Hide Breakdown</span></a></span><div style="DISPLAY: none" id="quoteBreakdownDetails" class="tableBreakdownInfo"><span class="quoteBreakdownDetails1 quoteBreakdownDetailsText">Cost of Life Cover: &euro;8.35</span><br /><span class="quoteBreakdownDetails2 quoteBreakdownDetailsText">Irish Life Policy Fee: &euro;6.50</span><br /><span class="quoteBreakdownDetails3 quoteBreakdownDetailsText">Government Levy: &euro;0.15</span><br /><span class="quoteBreakdownDetails4 quoteBreakdownDetailsText">&nbsp;</span></div></td></tr><tr class="ilfsQuoteBenefits"><td>'+
	'<ul><li>Life assurance valued at <span class="progressLifeCoverAmount ">&euro;</span></li>'+
	'<li>Premium you pay is <span class="progressQuote">&euro;</span> per month for <span class="progressLifeCoverYears">10</span> years</li>'+
	...
	'<a id="getRHSCallback" class="ilfsRHSSubmitbtn" href="javascript:void(0);" ga-click="" ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="Get Instant Quote Clicked">Call me back&nbsp; &euro;º</a><div class="clearer"></div>';
...
'<a id="getAnotherQuote" style="margin-top:15px;float:left" class="ilfsMovebtn leftbtn" href="javascript:void(0);" ga-click="" ga-category="ilfs-life-quote" ga-action="Page 1" ga-label="Get Another Quote Clicked" style="float: left;"><span class="ilfs-hide-for-small">GET ANOTHER QUOTE</span><span class="ilfs-show-for-small">NEW QUOTE</span>&nbsp; &euro;º</a>';
	// all the screens added
	

     //this is so the default option will be to have a callback if myILFS.callback is not specified

    if(typeof myILFS.callback === 'undefined'){
        myILFS.callback = true;
    }

    if(myILFS.callback){
        $('#ilfsWidget').html(html.progress+'<div class="row"><div class="eightcol"><div id="screen1">'+html.sliderHeader+html.sliderBox+html.detailsHeader+html.detailsBox+html.screen1ComplyBox+html.detailsNextBtn+'</div><div id="screen2" class="withCallback" style="display:none">'+html.detailsNext2+html.screen2ComplyBox+html.detailsNext2Btn+'</div><div id="screen3" style="display:none">'+html.detailsNext3+html.detailsNext3Btn+'</div><div id="screen4" style="display:none;">'+html.detailsNext4+'</div></div><div class="fourcol last"><div id="ilfsRHSCallback">'+html.detailsRHSCallback+'</div></div></div>');
    }
    else {
        $('#ilfsWidget').html(html.progress+'<div class="row"><div class="twelvecol"><div id="screen1">'+html.sliderHeader+html.sliderBox+html.detailsHeader+html.detailsBox+html.screen1ComplyBox+html.detailsNextBtn+'</div><div id="screen2" style="display:none">'+html.detailsNext2+html.screen2ComplyBox+html.detailsNext2Btn+'</div><div id="screen3" style="display:none">'+html.detailsNext3+html.screen4ComplyBox+html.detailsNext3Btn+'</div><div id="screen4" style="display:none;">'+html.detailsNext4+'</div></div><div style=display":none" class="fourcol last"></div></div>');
    }
	...
	if (myILFS.secondPerson==true)
	{
		...
		else
		{
			if (p2dob && p1dob)
			{
				...
				ilfsQuote.loadScript('https://www.irishlife.ie/myonlineservices/servlet/LifeCoverQuote/?'+ params, ilfsQuote.scriptLoaded,params);
			}
			else{
				if (termError)
				{
...
script.type = "text/javascript";
    ...
    scriptLoaded: function(params) {
		...
		if (v !="error"){ // success
			...
			$('.ilfsQuoteResult').html(" &euro;"+(parseInt(myILFS.quote.premInclLevy*100)/100).toFixed(2));
			if (myILFS.secondPerson == true && ILFSDualPersons == false)
			{
				if(ILFSDualPersons){
					$('.quoteBreakdownDetails1').html("Cost of Life Cover: &euro;"+(parseInt((myILFS.quote.premOptionalExtras3)*100)/100).toFixed(2));
				}
				else
				{
					
					$('.quoteBreakdownDetails1').html("Cost of Life Cover for Person 1: &euro;"+(parseInt((myILFS.quote.premOptionalExtras1)*100)/100).toFixed(2));
					$('.quoteBreakdownDetails2').html("Cost of Life Cover for Person 2: &euro;"+(parseInt((myILFS.quote.premOptionalExtras2)*100)/100).toFixed(2));
				}
			
			
				$('.quoteBreakdownDetails3').html("Irish Life Policy Fee: &euro;"+(parseInt(myILFS.quote.fee*100)/100).toFixed(2));
				$('.quoteBreakdownDetails4').html("Government Levy: &euro;"+(parseInt(myILFS.quote.levy*100)/100).toFixed(2));
			}else{

				$('.quoteBreakdownDetails1').html("Cost of Life Cover: &euro;"+(parseInt((myILFS.quote.prem-myILFS.quote.fee)*100)/100).toFixed(2));
				$('.quoteBreakdownDetails2').html("Irish Life Policy Fee: &euro;"+(parseInt(myILFS.quote.fee*100)/100).toFixed(2));
				$('.quoteBreakdownDetails3').html("Government Levy: &euro;"+(parseInt(myILFS.quote.levy*100)/100).toFixed(2));
			
			}
			// Set the sum assured amount
			$('.progressLifeCoverAmount').html("&euro;"+(parseInt(r.lifeCoverAmt*100)/100).toFixed(0).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
			$('.progressLifeCoverYears').html(r.term);
			
			$('.progressQuote').html(" &euro;"+(parseInt(myILFS.quote.premInclLevy*100)/100).toFixed(2));
