...
$(document).ready(function () {
    if(window.location.href.indexOf("?src=daft") > -1) {
        ...
        $('header.masthead').css('background-image','url(/sites/retail/files/campaigns/family-protection-2018/js/protection-planner-family.jpg)');
		...
		$('.insert-image').attr('src','/sites/retail/files/campaigns/family-protection-2018/vendor/assets/family-protection-DAFT.png');
		
    }
	else {
		$('header.masthead').css('background-image','url(/sites/retail/files/campaigns/family-protection-2018/js/irishlife-family-protection.jpg)');
		...
		$('.insert-image').attr('src','/sites/retail/files/campaigns/family-protection-2018/vendor/assets/family-protection.png');
	}
