...
var bline = '/pensions/pension-calculators/pension-gap-calculator';
var bankSite;
if( document.location.href.indexOf('ulsterbank') > -1 || 
	...
	document.location.href.indexOf('bline') > -1 || 
...
//console.log('bank site is ' + bankSite);
var chartColours = [
           '#5261ac', 
           '#5582AB', 
           '#A49382'
...
$(".get-callback").click(function(){
  setMKVisitWebPageView(window.location.pathname+'/callback-page');
  setGAPageView(window.location.pathname+'/callback-page','Pension calculator Callback Page');
  setSCamPageView(window.location.pathname+'/callback-page');
  $("#nextBtn").click();
});
...
function loadSliders(){
  //console.log('in loading sliders');
...
changeScreen = function (showScreen){
    ...
    if(showScreen == "LoadingPage"){
      ...
      $('.meter-wrap').show();
		...
		if (showScreen == "3" && bankSite == false) {
			  $("#screenLoadingPage").hide();
		...
		else if (showScreen == "3" && bankSite == true) {
			  $("#screenLoadingPage").hide();
			  $('#screen'+showScreen).fadeIn("1000");	
		}
...
function premiumQuote(){
    ...
    if(navigator.appVersion.indexOf("MSIE 8.")!=-1){
        $.getScript( 'https://www.irishlife.ie/myonlineservices/servlet/submitPensionQuote?'+ params, premiumResults );
    }
    else if (navigator.appVersion.indexOf("MSIE 7.")!=-1) {
        $.getScript( 'https://www.irishlife.ie/myonlineservices/servlet/submitPensionQuote?'+ params, premiumResults );
    }
    else{
        newScript.src = 'https://www.irishlife.ie/myonlineservices/servlet/submitPensionQuote?' + params;
		//console.log(params);
...
function annualPensionQuote(){
    ...
    if(navigator.appVersion.indexOf("MSIE 8.")!=-1){
        $.getScript( 'https://www.irishlife.ie/myonlineservices/servlet/submitPensionQuote?'+ params, annualPensionResults );
    }
    else if (navigator.appVersion.indexOf("MSIE 7.")!=-1) {
        $.getScript( 'https://www.irishlife.ie/myonlineservices/servlet/submitPensionQuote?'+ params, annualPensionResults );
    }
...
function emailTheBroker() {
    ...
    if ($("#telephoneBR").val().length >=7 && $("#telephoneBR").val().length <=20 && $("#nameBR").val() !="" ) {
		...
		var URL = "https://www.irishlife.ie/servlet/submitForm.do";
