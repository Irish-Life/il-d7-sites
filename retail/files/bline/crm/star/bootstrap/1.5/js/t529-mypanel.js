		...
		$.each( myPanel, function( key, v ) {
			...
			$('.my-panel-table').append(
				'<tr>'+
					...
					'<td class="border-right-0">'+getArrowIcon(thisyearMargin,lastyearMargin)+'</td>'+
					'<td class="border-left-0">'+thisyearMarginFormatted+'</td>'+
					'<td class="border-right-0">'+getArrowIcon(thisyearApe,lastyearApe)+'</td>'+
					'<td class="border-left-0">'+thisyearApeFormatted+'</td>'+
