(function($) {
	...
	$('.mytasks-callsopen').html(myTasksOpenCount[0].agsubject.value);
		function getDataResults(results){
			...
			ilp_thisyearcorporatebusinessytdape,ilp_lastyearcorporatebusinessytdape,ilp_thisyearcorporatebusinessytdmargin,ilp_lastyearcorporatebusinessytdmargin,agname,ilp_volumenumberofcases,ilp_lastyearvolumenumberofcases];
		...
		console.log("testing "+JSON.stringify(currentUser));
		...
		if (currentUser[0].businessunitid == "Broker Source"){
			...
			*/
			...
			//console.log("resultsMy "+JSON.stringify(resultsMy));
