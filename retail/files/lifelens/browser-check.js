  ...
  function BrowserBanner($) {
    ...
    function maybeShowBanner() {
      if (!isSupportedBrowser()) {
        ...
        $browserBanner.html('You are using an unsupported browser, so some features may not work. <br> Please upgrade to a <a href="http://browsehappy.com/">modern browser</a>.');
