...
var screens = ["splash", "yourInfo", "yourFamily", "yourJob", "yourExpenses", "firstResults", "secondResults", "thirdResults"];
...
$(document).ready(function() {
    ...
    $('#noKids').change(function() {
	 ...
	 $('#numChild').mouseup(function() {
		if (parseInt($('#numChild input').val(), 10) == 0)
		{
			$("#disabler").show();
		}        
		else{
...
function checkMaxAgeTermAndCover() {
    ...
    {
        $('#canQuote').hide();
        if(gup('broker') == 'Y' || gup('aib') == 'Y' || gup('financial-planning')=='Y'){
            $('#directToCallbackFromChart').hide();
        } else{
...
function updateChart() {
	...
	//console.log("drop in income - p1welfare " + (dropInIncome - p1Welfare));
	...
	//console.log("income deficit = " + incomeDeficit);
    covered = covered.toFixed(0);
    covered = parseInt(covered);
    var need = p1MonthlyNeed - (p1Welfare + covered); 
    lifeInsuranceRequired = parseInt(insuranceRequiredCalc(need, covered));
...
function quoteResults() {
    ...
    if (gup('aib') == 'Y' ){
		$("#productLink").attr('href','http://personal.aib.ie/our-products/insurance/term-life-insurance');
		$("#productLink").attr('title','This is an external link to aib.ie');
        $("#detailsABOption1").addClass("hidden");
        $("#detailsABOption2").addClass("hidden");
        $("#detailsABOption3").addClass("hidden");

        $("#AIBOption1").addClass("hidden");
        $("#AIBOption2").removeClass("hidden");

        $("#IlCallback").addClass("hidden");
        $("#AIBCallback").removeClass("hidden");

    } else if (gup('broker') == 'Y') {
        $("#FPOption1").removeClass("hidden");
        $("#FPOption2").removeClass("hidden");;
        $("#detailsABOption1").addClass("hidden");
        $("#detailsABOption2").addClass("hidden");
        $("#detailsABOption3").addClass("hidden");
        $("#IlCallback").addClass("hidden");
    } else if (gup('financial-planning') == 'Y') {
        $("#FPOption1").removeClass("hidden");
        $("#FPOption2").removeClass("hidden");;
        $("#detailsABOption1").addClass("hidden");
        $("#detailsABOption2").addClass("hidden");
        ...
        $("#IlCallback").removeClass("hidden");
        $("#AIBCallback").addClass("hidden");
...
function insuranceRequiredCalc(mn, lc) {
	//console.log("monthly need to calc life insurance from: " + mn);
	//console.log("existing cover to take into account: " + lc);
	...
	//console.log("life insurance required: " + lifeInsurance);
