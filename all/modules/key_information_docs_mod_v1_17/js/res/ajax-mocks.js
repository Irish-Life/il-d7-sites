...
function GetKid(token, timestamp, premiumType, distributionCode, productCode, fundCode) {
    ...
    var url = 'https://www.irishlife.ie/myonlineservices/KidQueryApi/DownloadFile';
...
function getServerDate() {
	...
	$.ajax( { type : 'GET',
	 ...
	 url  : 'https://www.irishlife.ie/sites/all/modules/key_information_docs_mod_v1_17/js/res/functionDate.php',  
	  //data : data,
	  async: false,
...
function GetKidList(token, timestamp) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://www.irishlife.ie/myonlineservices/KidQueryApi/List',
        headers: {
