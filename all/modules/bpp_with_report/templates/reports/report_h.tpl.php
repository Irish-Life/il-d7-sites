<?php
  ...
  // COVER
  ?>
  <div class="front-img" style="background:url('<?php echo drupal_get_path('module', 'bpp_with_report');?>/images/personal-shareholder-protection-report.jpg') no-repeat;"><div class="front-author">Prepared for <?php echo $businessName ?></div></div>
  <pagebreak>
  <?php
  ///////////////////////
  ///////////////////////
