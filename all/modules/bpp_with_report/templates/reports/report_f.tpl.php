<?php
  ...
  // COVER
  ?>
  <div class="front-img" style="background:url('<?php echo drupal_get_path('module', 'bpp_with_report');?>/images/corporate-shareholder-protection-report-cover.jpg') no-repeat;"><div class="front-author">Prepared for <?php echo $businessName ?></div></div>
  <pagebreak>
  <?php
  ///////////////////////
  ///////////////////////
...
<pagebreak>
    ...
    <p>The level of cover on each individual contract is the estimated value of the individuals share in the company. The level of cover will also be subject to full medical and financial underwriting.</p>
