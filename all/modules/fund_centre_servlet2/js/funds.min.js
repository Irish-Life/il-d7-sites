...
setDefaultFunds = function(data, productGroup){
	...
	<th class=\"sort\" width=\"5%\" data-sort=\"starred\">Fav</th>\
	<th class=\"sort\" width=\"5%\"data-sort=\"charted\">Chart</th>\
	<th class=\"sort\" width=\"9%\" data-sort=\"risk\" "+Drupal.settings.fund_centre.riskDisplay+" >Fund Risk Level</th>\
	<th class=\"sort leftAlign\" width=\"23%\" data-sort=\"name\">Name</th>\
	...
	for (i=0;i<retailFundGroupUpperLimits.length; i++){	
		...
		<th class=\"fundOptionsHeader\" colspan=\"7\"><h3>"+currentFundGroupNames[i]+" @ <span class=\"thePriceDate\">~<\span></h3></th>"+tableHeader;
	}
	...
	$.each(data[0], function(key, val) {
		$.each(val, function(index, vale) {
			...
			tableBodyContents[fundGroupIDtemp] += "<td class=\"mobileRow\" style=\"DISPLAY: none\"><div class=\"mobileRiskRating riskRating rated-"+vale.risk+"\"><span class=\"rateditem\">"+vale.risk+"</span></div><div class=\"mobilePrice "+ fc(vale.latest) +" \">&euro;"+vale.latest+"</div><div class=\"mobileFromLaunch "+ fc(vale.sinceLaunchGrowth) +" \">"+vale.sinceLaunchGrowth+"<div></td>";
			...
			tableBodyContents[fundGroupIDtemp] += "<td class=\"risk\" "+Drupal.settings.fund_centre.riskDisplay+ "><div class=\"riskRating rated-"+vale.risk+"\">\
...
getProductFundPrices = function(id, name){
	...
	$('#fundsTableBody').html("<img alt=\"Loading\" src=\"/sites/all/modules/fund_centre/css/images/ajax-loader.gif\"> Loading Funds, Please Wait.");
...
setProductFunds = function(data,productGroupID,name){
	...
	for (i=0;i<productGroupNames.length; i++){	
		...
		<th class=\"fundOptionsHeader\" colspan=\"7\"><h3>"+productGroupNames[i]+" @ <span class=\"thePriceDate\">~<\span></h3></th>"+tableHeader;
	}
	...
	for (i=0;i<productGroupNames.length; i++){
		...
		// don't display empty tables
			...
			$('#fundsTableBody').append('<span style="display:none">'+localTableHolder[i]+'</span>');
		}
	}
