...
function sessionCamHideText() {
    $('.displayOutputField').addClass('sessioncamhidetext');
	$('.topRightMenuUser').addClass('sessioncamhidetext');
	$('#planColumn1 td').addClass('sessioncamhidetext');
	$('#fund-analysis-assets-plans-grid td a').addClass('sessioncamhidetext');
	$('#benefitDetailsSummaryGrid .heading-text').addClass('sessioncamhidetext');
	$('#premiumDetailsTabs .gridBase2 td').addClass('sessioncamhidetext');
	$('#printBody .irishlife-title').addClass('sessioncamhidetext');
	$('#summarySection td').addClass('sessioncamhidetext');
	$('#benefitSection th').addClass('sessioncamhidetext');
	$('#notificationsForm td span').addClass('sessioncamhidetext');  
	$('#clientDocumentsGrid .first').addClass('sessioncamhidetext');  
}
