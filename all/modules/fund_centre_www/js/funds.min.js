...
showFundScreen = function(fundId,name) {
	...
	var performanceCategories = [];
	  ...
	  $.each(data, function(key, val) {
			...
			if (fundId == val.FundId)
			{
				...
				$("#fundScreenBody #fundRisk").html(val.FundRiskRating);
	...
	$.ajax({
					type:'POST',
					url:"https://www.irishlife.ie/myonlineservices/FundApi/RetrieveFundPerformanceCharts?fundId="+fundId, //SINGLE FUND INFO AJAX CALL
...
getChartDataAgain = function(whichChart){
	...
	$.ajax({
	    type: 'POST', 
		url: 'https://www.irishlife.ie/myonlineservices/FundApi/RetrieveFundComparisonChart?fundIds='+fundString.slice(0, -1), //COMPARE AJAX CALL CHANGE TO IRISHLIFE.IE WHEN GOING LIVE
...
pullDownOverallFundData = function(){
	...
	$.ajax({
		type:'POST',
		url:"https://www.irishlife.ie/myonlineservices/FundApi/RetrieveFundsPerformance?fundGroupId="+fundGroupMain, //OVERALL AJAX CALL CHANGE TO IRISHLIFE.IE WHEN GOING LIVE
		success:function(response) {
...
setDefaultFunds = function(data, productGroup){
	...
	// Loop through data
		...
		//$.each(val, function(index, vale) {
			...
			tableBodyContents[fundGroupIDtemp] += "<td class=\"mobileRow\"><div class=\"mobileRiskRating circle-risk rated-"+val.FundRiskRating+"\"><span class=\"rateditem\">"+val.FundRiskRating+"</span></div><div class=\"mobilePrice "+val.CurrentPrice +" \">&euro;"+val.CurrentPrice+"</div><div class=\"mobileFromLaunch "+val.SinceLaunchPercent+" \">"+val.SinceLaunchPercent+"<div></td>";
			...
			<span class=\"rateditem\">"+val.FundRiskRating+"</span></div></td>\
...
getProductFundPrices = function(id, name){
	...
	else
	{
		if (id > 0)
		{
			var jqxhr = $.post( "https://www.irishlife.ie/myonlineservices/FundApi/RetrieveFundsPerformance?fundGroupId="+id, function() {
			})
			.done(function(data) {
...
getFundProductsList = function(){
	...
	$.post('https://www.irishlife.ie/myonlineservices/FundApi/RetrieveFundGroups?applicationId='+productGroupsId, function (data, error){
