...
$(document).ready( function() {
    ...
    $("#start").click(function(event) {
      $("#splash").fadeOut(function() {
        $("#pageOne").fadeIn('1000',function(){
	     ...
	     setGAPageView('/income-protection-quote-step-1','Your details screen');
		 setSCamPageView('/income-protection-quote-step-1');
    });
    ...
    $("input[name=radio2]:radio").change(function(){
      if($("#selfEmployedYes").attr("checked")){
        ...
        coveredByState = 0;
        $("#sateAmount").html(euro + "0");
      } else {
        coveredByState = 9776;
        $("#sateAmount").html(euro + "9776");
      }
      addData();
    });
    ...
    $("#getQuote").click(function(event){
      ...
      if ( getInputs() ){
        $("#pageOne").fadeOut(function(){
            ...
            mkVisitWebPage(trackpageurl+'/quote-completed');
            setGAPageView('/income-protection-quote-step-2','Your quote details screen');
			setSCamPageView('/income-protection-quote-step-2');
        });
      }
    });
    ...
    $("#thirdScreenResultsBckBtn").click(function(){
        $("#pageThree").fadeOut(function(){
           $("#pageTwo").fadeIn("1000");
              mkVisitWebPage(trackpageurl+'/results');
              setGAPageView('/income-protection-quote-step-2','back button clicked - now on your quote details screen');
              setGAPageView('/income-protection-quote-step-2/quote-completed','Quote completed');
			  setSCamPageView('/income-protection-quote-step-2-back');
        });
    });
    ...
    $("#back").click(function(event){
        ...
        $("#pageTwo").fadeOut(function(){
          ...
          $("#pageOne").fadeIn("1000");
          setGAPageView('/income-protection-quote-step-1','back button clicked - now on your details screen');
		  setSCamPageView('/income-protection-quote-step-1-back');
        });
    });
     ...
     $("#bookReview").click(function(){
        ...
        setGAPageView('/income-protection-quote-step-3','callback started');
		setSCamPageView('/income-protection-quote-step-3');
    });
...
$.ajax({
    ...
    url: "/sites/all/modules/income_protection_calc/occupationDataInsight.xml",
	//url: "http://www.irishlife.ie/myonlineservices/servlet/occupationDataInsight.xml",
...
function populateDropdowns(){
  ...
  html += "<option selected value="+start+">" + start + "</option>";
...
function populateResults () {
  ...
  $("#deferredResult").html(p1DeferredPeriod + " weeks");
...
function quoteResults(){
	...
	$("#prem").html(euro + premOptionalExtras1);
    $("#levy").html(euro + (levy).toFixed(2));
    $("#inflation").html(euro + (premEsc1).toFixed(2));
    $(".monthlyPrem").html(euro + (premInclLevy).toFixed(2));
...
function emailInfo() {
    ...
    if ($("#telephone").val().length >=7) {
        ...
        setGAPageView('/income-protection-quote-step-4','callback completed');
		setSCamPageView('/income-protection-quote-step-4');
